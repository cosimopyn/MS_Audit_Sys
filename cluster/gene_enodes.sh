...
ENODE_URL='enode://'"${PUBKEY}@127.0.0.1:$((PORT+2))"'?discport=0&raftport='"$((RAFT_PORT+2))"
...
ENODE_URL='enode://'"${PUBKEY}@127.0.0.1:$((PORT+3))"'?discport=0&raftport='"$((RAFT_PORT+3))"
...
ENODE_URL='enode://'"${PUBKEY}@127.0.0.1:$((PORT+4))"'?discport=0&raftport='"$((RAFT_PORT+4))"
...
ENODE_URL='enode://'"${PUBKEY}@127.0.0.1:$((PORT+5))"'?discport=0&raftport='"$((RAFT_PORT+5))"
...
ENODE_URL='enode://'"${PUBKEY}@127.0.0.1:$((PORT+6))"'?discport=0&raftport='"$((RAFT_PORT+6))"
